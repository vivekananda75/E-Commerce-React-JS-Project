...
<Link to="/">   <h1 className="logo-text">MART</h1></Link>
   </div>   
   <ul className="d-flex nav-links gap-5 ">
   <Link to="/"><li  className="link-">Home</li></Link>
   <Link to="Productpage"><li className="link-">Shop</li></Link>
     <Link to="Cartpage"><li className="link-">Cart</li></Link>
   <li className="link-"><IoPerson/></li>
    <li>
